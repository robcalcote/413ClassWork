"""
Django settings for project2class project.
...
SECRET_KEY = '*j(+y$8)_syako+2@e2_xn_1^m=kznqsx^qpmivgxo9=!m102g'
...
# These are the keys for stripe
STRIPE_PUBLIC_KEY = "pk_test_LUyr9dTrFLdBNLiJqIIzJQjp00uGwGJ0nk"
STRIPE_SECRET_KEY = "sk_test_LfQldqSZtl2cgMilulhPME6M00XD5kG4YL"
...
MIDDLEWARE = [
    ...
    #'django.middleware.csrf.CsrfViewMiddleware', #Make sure to uncomment when deploying
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'project2class.urls'
